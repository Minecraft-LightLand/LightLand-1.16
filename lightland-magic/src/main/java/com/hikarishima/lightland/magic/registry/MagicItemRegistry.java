...
public class MagicItemRegistry {
    ...
    public static final RegistryObject<MagicPickaxe> PER_PICKAXE = regItem("permanence_iron_pickaxe", (p) -> new MagicPickaxe(MagicItemTier.PERMANENCE, 1, -2.8f, p.stacksTo(1)));
    public static final RegistryObject<MagicShovel> PER_SHOVEL = regItem("permanence_iron_shovel", (p) -> new MagicShovel(MagicItemTier.PERMANENCE, 2, -3f, p.stacksTo(1)));
    public static final RegistryObject<MagicHoe> PER_HOE = regItem("permanence_iron_hoe", (p) -> new MagicHoe(MagicItemTier.PERMANENCE, 1, -1f, p.stacksTo(1)));
