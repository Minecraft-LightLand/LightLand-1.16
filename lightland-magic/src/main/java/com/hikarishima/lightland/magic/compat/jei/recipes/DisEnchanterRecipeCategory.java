...
import com.hikarishima.lightland.magic.compat.jei.LightLandJeiPlugin;
import com.hikarishima.lightland.magic.compat.jei.ingredients.Countable;
...
public class DisEnchanterRecipeCategory implements IRecipeCategory<IMagicRecipe<?>> {
    ...
    public DisEnchanterRecipeCategory() {
        this.id = new ResourceLocation(LightLandMagic.MODID, "disenchant");
    }
