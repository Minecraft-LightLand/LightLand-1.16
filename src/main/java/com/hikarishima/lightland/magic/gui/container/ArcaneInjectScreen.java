...
public class ArcaneInjectScreen extends ContainerScreen<ArcaneInjectContainer> {
    ...
    public ArcaneInjectScreen(ArcaneInjectContainer cont, PlayerInventory plInv, ITextComponent title) {
        ...
        this.imageHeight = ArcaneInjectContainer.MANAGER.getHeight();
        this.inventoryLabelY = ArcaneInjectContainer.MANAGER.getPlInvY() - 11;
    }
    ...
    protected void renderBg(MatrixStack matrix, float partial, int mx, int my) {
        mx -= getGuiLeft();
        my -= getGuiTop();
        SpriteManager sm = ArcaneInjectContainer.MANAGER;
